...
* Last Modified : Wed 01 Apr 2026 09:22:06 AM EDT
...
# dotplots
files = {'fig5j_icam1_itgal': 'icam1_itgal.pkl', 'fig5j_cd40lg_cd40_anxa1_fpr3': 'cd40lg_cd40_anxa1_fpr3.pkl', 'fig5f_wnt': 'wnt.pkl'}
for tag, f in tqdm(files.items()):
    ...
    plt.savefig(os.path.join(FIG_DIR, f'{tag}_lr.pdf'), bbox_inches='tight')
    plt.close()

# proximity score boxplots
fig_name_dict = {
    'icam1_dc_itgal_cd4t': 'exfig6g',
    'icam1_dc_itgal_cd8t': 'exfig6g',
    'cd40lg_cd4t_cd40_dc': 'exfig6i',
    'anxa1_cd4t_fpr3_dc': 'exfig6h'
}
...
for f, (center, target) in tqdm(prox_files.items()):
    ...
    for key, df in pkl.items():
        ...
        plt.savefig(os.path.join(FIG_DIR, f'{fig_name}_{f}_{key}.pdf'), bbox_inches='tight')
        plt.close()
